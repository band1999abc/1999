...
-----END ${descriptor}-----`;
  ...
  // music-upload-client.js
  var music_upload_client_exports = {};
  __export(music_upload_client_exports, {
    uploadMusicBlob: () => uploadMusicBlob
  });
  ...
  function blobPathFor(musicId) {
    const entropy = typeof crypto.randomUUID === "function" ? crypto.randomUUID().replace(/[^a-z0-9-]/gi, "").toLowerCase() : Math.random().toString(36).slice(2, 12);
  ...
  return __toCommonJS(music_upload_client_exports);
})();
